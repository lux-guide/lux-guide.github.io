...
window.KB = {
  ...
  fiches: [
    {
      ...
      corps: [
        ...
        { h: "Trois délais, pas un seul" },
        "Le délai de huit jours vaut pour la déclaration d'arrivée au bureau de la population. Deux autres délais s'y ajoutent, et les manquer coûte plus cher que le premier.",
        "Un ressortissant de pays tiers dispose non pas de huit jours mais de trois jours à compter de son arrivée sur le territoire pour cette même déclaration. Le délai est court, et il court dès l'entrée, pas depuis l'emménagement.",
        "Ensuite, la déclaration d'arrivée ne suffit pas à elle seule. Un citoyen de l'Union qui reste plus de trois mois doit remplir, dans les quatre-vingt-dix jours de son arrivée, une déclaration d'enregistrement auprès de la même commune. Un ressortissant de pays tiers doit, lui, introduire une demande de titre de séjour dans les trois mois de son arrivée. Ce sont deux formalités distinctes de la première, avec leur propre échéance.",
      ...
      aRetenir: [
        "Huit jours après l'emménagement, pas après la signature du bail. Trois jours seulement pour un ressortissant de pays tiers.",
    ...
    },
    {
      ...
      corps: [
        ...
        "Les niveaux de prix ne sont pas les mêmes des quatre côtés, et l'écart ne va pas toujours dans le même sens. Les indices d'Eurostat, publiés dans l'onglet Les communes en passant de l'autre côté de la frontière, montrent que l'alimentation, l'habillement et les télécommunications reviennent moins cher chez les voisins, tandis que l'énergie, les carburants et le tabac le sont au Luxembourg. Un ménage frontalier fait donc rarement tout du même côté.",
    ...
    },
    {
      ...
      cat: "Impots",
      resume: "Trois classes seulement, 1, 1a et 2 : pas de classe 1b. À revenu égal, l'écart entre classe 1 et classe 2 dépasse souvent mille euros par mois.",
      tags: ["impôt", "classe", "1a", "barème", "splitting", "marié", "célibataire", "fiche de retenue", "imposition"],
      corps: [
        "Trois classes d'imposition coexistent, et trois seulement : il n'existe pas de classe 1b, ni de sous-classes du type 1a/1 ou 2/2, qui ont disparu en 2008. Votre classe pèse davantage sur votre net que bien des négociations salariales.",
        "La classe 2 s'applique aux époux et partenaires imposés collectivement, avec un mécanisme de splitting qui allège fortement l'impôt. Elle s'applique aussi, pendant une période transitoire de trois ans, aux personnes dont le mariage a été dissous par décès, par divorce ou par séparation.",
        "La classe 1a regroupe trois situations, à condition de ne pas relever de la classe 2 : les personnes veuves, les personnes qui bénéficient d'une modération d'impôt pour enfants, et les personnes ayant terminé leur soixante-quatrième année au début de l'année d'imposition. Elle applique un barème intermédiaire, dont l'avantage se réduit à mesure que le revenu augmente. Attention au deuxième cas : il ne se limite pas aux parents isolés, il vise toute personne qui bénéficie de la modération pour un enfant de son ménage.",
        "La classe 1 est la catégorie résiduelle : elle comprend les personnes qui n'appartiennent ni à la classe 1a, ni à la classe 2. C'est la classe de la plupart des célibataires sans enfant, et celle d'un couple dont le conjoint réside encore à l'étranger.",
  ...
  faq: [
    ...
    { q: "Comment comparer deux contrats d'assurance ?", a: "Sur les exclusions et les franchises, pas sur la prime. Demandez le document d'information standardisé de deux pages, les conditions générales et les conditions particulières : un devis ne dit rien de ce qui sera refusé le jour du sinistre.", fiche: "assurance_habitation" },
    { q: "Comment l'impôt est-il prélevé quand on est deux à travailler ?", a: "Non, et il ne peut pas le déduire. Le taux inscrit sur la fiche additionnelle du second salaire ne dépend que de la classe d'impôt : 15 % en classe 2, 21 % en classe 1a, 33 % en classe 1. Il ne contient aucune information sur le revenu du ménage.", fiche: "impots_classes" },
    { q: "Pourquoi la déclaration se solde-t-elle souvent par un montant à payer ?", a: "Parce que le taux forfaitaire appliqué au second salaire sous-prélève souvent. La déclaration commune recalcule l'impôt réellement dû sur le revenu cumulé. Les années suivantes, l'administration lisse l'écart par des avances trimestrielles.", fiche: "impots_classes" },
    { q: "Les délais d'arrivée sont-ils les mêmes hors Union européenne ?", a: "Non, le délai est plus court. La déclaration d'arrivée à la commune doit être faite dans les trois jours de votre entrée sur le territoire, et non dans les huit jours. Vous devez ensuite introduire une demande de titre de séjour dans les trois mois de votre arrivée.", fiche: "arrivee" },
    { q: "La déclaration à la commune suffit-elle ?", a: "Non, une seconde formalité suit. Un citoyen de l'Union qui reste plus de trois mois doit remplir une déclaration d'enregistrement auprès de la commune dans les quatre-vingt-dix jours de son arrivée. Un ressortissant de pays tiers doit demander son titre de séjour dans les trois mois. Ce sont des démarches distinctes de la déclaration d'arrivée, avec leur propre échéance.", fiche: "arrivee" },
    { q: "Un compte bancaire étranger peut-il servir à recevoir le salaire ?", a: "Oui, un IBAN de la zone SEPA ne peut pas être refusé pour le versement d'un salaire ou le paiement d'un loyer. En pratique, deux choses poussent quand même à ouvrir un compte local : la garantie locative, que les banques étrangères n'émettent généralement pas, et LuxTrust, souvent offert aux clients d'une banque luxembourgeoise.", fiche: "banque" },
    { q: "Que faut-il pour ouvrir un compte bancaire ?", a: "Une pièce d'identité, un justificatif d'adresse et, le plus souvent, le contrat de travail. Comparez les grilles tarifaires avant de choisir : elles varient nettement d'un établissement à l'autre, sur les frais de tenue de compte comme sur le coût des cartes et des virements.", fiche: "banque" },
    { q: "Qui déclare l'entrée à la sécurité sociale ?", a: "Non si vous êtes salarié : c'est l'employeur qui déclare votre entrée au Centre commun de la sécurité sociale, sans démarche de votre part. Votre carte arrive ensuite par courrier. Les travailleurs indépendants, eux, déclarent leur activité eux-mêmes, dans un délai de huit jours.", fiche: "matricule" },
    { q: "Le luxembourgeois est-il nécessaire pour travailler ?", a: "Cela dépend du poste. Trois langues sont administratives, le français, l'allemand et le luxembourgeois, et l'anglais est très présent dans les entreprises internationales. En revanche, les postes de la fonction publique demandent souvent les trois langues du pays.", fiche: "langues" },
    { q: "Combien de temps faut-il pour obtenir la nationalité ?", a: "La naturalisation suppose une résidence durable et une épreuve de langue. Le volet linguistique est le plus long à préparer, ce qui vaut de commencer les cours dès la première année si la naturalisation vous intéresse, sans attendre d'y être contraint.", fiche: "nationalite" },
    { q: "Le salaire luxembourgeois compense-t-il le coût de la vie ?", a: "Comparez sur le brut annuel, treizième mois compris, et intégrez le logement dès le début du calcul : c'est lui qui absorbe l'essentiel de l'écart de salaire avec les régions voisines. Le salaire social minimum figure parmi les plus élevés d'Europe et sert de référence à de nombreux plafonds sociaux et fiscaux.", fiche: "cout_vie" },
    { q: "Dans quel délai faut-il se déclarer à la commune ?", a: "Dans les huit jours suivant l'emménagement. Cette déclaration produit le certificat de résidence et le matricule, indispensables à toute la suite. Prenez rendez-vous en ligne avant même d'avoir les clés.", fiche: "arrivee" },
    { q: "Comment obtient-on le matricule ?", a: "Il est attribué lors de l'enregistrement à la commune et figure sur le certificat de résidence, sous la mention numéro d'identification. Il compte treize chiffres : votre date de naissance inversée, suivie de cinq chiffres.", fiche: "arrivee" },
    { q: "Un compte bancaire luxembourgeois est-il obligatoire ?", a: "Pas légalement : un IBAN européen suffit pour le salaire et le loyer. En pratique, un compte local reste nécessaire pour émettre une garantie locative, et il rend LuxTrust souvent gratuit.", fiche: "banque" },
    { q: "Quelle garantie locative un bailleur peut-il demander ?", a: "Deux mois de loyer au maximum depuis la réforme du 1er août 2024, contre trois auparavant. Les frais d'agence sont par ailleurs partagés par moitié entre bailleur et locataire.", fiche: "bail" },
    { q: "Comment se cherche un logement au Luxembourg ?", a: "En préparant le dossier complet avant la première visite, et surtout en ayant déjà la capacité d'émettre une garantie bancaire. C'est ce point, plus que le loyer proposé, qui départage les candidats.", fiche: "recherche_logement" },
    { q: "À quel moment souscrire l'assurance habitation ?", a: "Avant la remise des clés : l'attestation fait partie du dossier de signature. Comparez sur les franchises, la valeur à neuf et les exclusions, en exigeant les conditions générales et pas seulement le devis.", fiche: "assurance_habitation" },
    { q: "Un permis de conduire européen reste-t-il valable ?", a: "Oui, sans limite de durée et sans obligation d'échange ni d'enregistrement. L'enregistrement reste utile pour obtenir rapidement un duplicata en cas de perte ou de vol.", fiche: "permis" },
    { q: "Comment s'immatricule un véhicule importé ?", a: "Cela dépend de votre cas. Import : contrôle technique, assurance, puis immatriculation. Achat chez un professionnel : il s'en charge. Achat entre particuliers : la démarche vous incombe, avec les deux parties du certificat.", fiche: "vehicule" },
    ...
    { q: "Existe-t-il une classe d'impôt 1b ?", a: "Non. Il n'existe que trois classes, 1, 1a et 2. Les sous-classes du type 1a/1, 1a/2 ou 2/3 ont disparu en 2008, quand la modération d'impôt pour enfant a cessé d'agir directement sur la classe.", fiche: "impots_classes" },
    { q: "Qui relève de la classe 1a ?", a: "Trois situations, à condition de ne pas relever de la classe 2 : les personnes veuves, celles qui bénéficient d'une modération d'impôt pour enfants, et celles ayant terminé leur soixante-quatrième année au début de l'année d'imposition. Le deuxième cas ne se limite pas aux parents isolés.", fiche: "impots_classes" },
    { q: "Un divorce ou un décès fait-il changer de classe d'impôt immédiatement ?", a: "Non. Une période transitoire de trois ans maintient en classe 2 les personnes divorcées, séparées, ou dont le mariage a été dissous par décès. Le basculement en classe 1 ou 1a intervient ensuite, selon la situation.", fiche: "impots_classes" },
    { q: "Le régime des impatriés dépend-il de la classe d'impôt ?", a: "Oui. Le régime porte sur la rémunération, pas sur la classe : il s'applique quelle que soit la classe d'impôt. Le tableau de comparaison du simulateur affiche le gain pour les trois classes, parce qu'un célibataire nouvellement arrivé relève le plus souvent de la classe 1 et que c'est là que le régime change le plus le net.", fiche: "impatries" },
    ...
    { q: "Qu'est-ce qui se déduit des impôts ?", a: "Au-delà des forfaits appliqués d'office : les frais de déplacement, les cotisations de prévoyance, les primes d'assurance, l'épargne-logement, les frais de garde et, sous conditions, les pensions alimentaires versées.", fiche: "deductions" },
    { q: "Comment faire corriger une classe d'impôt inexacte ?", a: "Cela arrive, surtout la première année. Ni vous ni l'employeur ne pouvez corriger la fiche de retenue : demandez la modification au bureau RTS compétent pour votre commune, de préférence avec le formulaire 164 R, sans attendre.", fiche: "conseil_fiscal" },
    { q: "Comment obtient-on sa fiche de retenue d'impôt ?", a: "Non, pour un salarié elle est émise automatiquement par l'administration après l'affiliation à la sécurité sociale, faite par l'employeur, sous une trentaine de jours ouvrables. La démarche utile, c'est de vérifier la classe inscrite dès réception.", fiche: "conseil_fiscal" },
    { q: "Les intérêts d'un prêt immobilier sont-ils déductibles ?", a: "Oui, pour l'habitation principale. La déduction est intégrale les deux premières années, puis plafonnée. Surtout, le plafond est multiplié par le nombre de membres du ménage, conjoint et enfants compris.", fiche: "interets" },
    { q: "Quelle part du prix une banque finance-t-elle ?", a: "Jusqu'à 100 % pour un primo-accédant en résidence principale, 90 % pour un acquéreur déjà propriétaire, et 80 % pour un investissement locatif. Les frais d'acte restent à financer sur fonds propres.", fiche: "achat" },
    ...
    { q: "Qui peut prétendre à un logement à coût modéré ?", a: "Il faut rester sous un plafond de revenu net du ménage et ne posséder aucun autre logement, au Luxembourg comme à l'étranger, au plus tard neuf mois après l'acte. Cette dernière condition vise aussi toutes les personnes vivant avec vous.", fiche: "logement_abordable" },
    { q: "Peut-on exercer une activité indépendante en plus d'un emploi salarié ?", a: "Déclarez-la au CCSS dans les huit jours. Si le revenu reste sous le tiers du salaire social minimum, demandez expressément la dispense pour revenu insignifiant. Vérifiez surtout si votre activité exige une autorisation d'établissement.", fiche: "independant" },
    { q: "Comment se fait l'inscription à l'école ?", a: "Commencez par là, avant même le logement. L'enregistrement à la commune précède l'inscription scolaire, et les sections les plus demandées se remplissent parfois un an à l'avance.", fiche: "ecole" },
    ...
    { q: "Combien de jours de congé donne la loi ?", a: "Vingt-six jours ouvrables de congé légal par an, plus onze jours fériés. Le droit s'ouvre après trois mois chez le même employeur, et les conventions collectives accordent souvent davantage.", fiche: "conges" },
    ...
    { q: "Faut-il apprendre le luxembourgeois ?", a: "Pas pour travailler : l'anglais et le français suffisent dans beaucoup de secteurs. En revanche, oui pour la naturalisation et pour de nombreux emplois publics. Des cours subventionnés existent.", fiche: "langues" },
    { q: "Quel numéro d'urgence appeler ?", a: "Le 112, gratuit et valable partout. Pour les soins courants, il n'existe ni médecin traitant obligatoire ni parcours de soins : vous consultez directement le spécialiste de votre choix.", fiche: "sante_pratique" },
